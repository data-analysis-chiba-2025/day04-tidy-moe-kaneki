...
gapminder_year <- arrange(gapminder, desc(year))
answer_3 <- select(gapminder_year, country, pop)

# 4. Answer question 4 again, byear()# 4. Answer question 4 again, but this time USE the pipe (|>). Save the
# result to answer_4
